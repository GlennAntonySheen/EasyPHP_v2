...
<body>
	<div>
		<ul id="nav">
			...
			<li><a href='<?php echo site_url('main/customers') ?>'><i class="bi bi-people"></i>Customers</a></li>
			<li><a href='<?php echo site_url('main/orderline') ?>'><i class="bi bi-house"></i>Order Line</a></li>
			<ul id="rightnav">
