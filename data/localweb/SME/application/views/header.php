...
<body>
	<div>
		...
		<li><a href='<?php echo site_url('main/area')?>'>Area</a></li>
		<li><a href='<?php echo site_url('main/resident')?>'>Resident</a></li>
		<li><a href='<?php echo site_url('main/product')?>'>Product</a></li>
